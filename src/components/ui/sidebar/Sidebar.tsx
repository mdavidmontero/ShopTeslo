...
export const Sidebar = () => {
  ...
  return (
    <div>
      ...
      <nav
        className={clsx(
          "fixed p-5 right-0 top-0 w-[350px] h-screen bg-white z-20 shadow-2xl transform transition-all duration-300 overflow-auto",
          {
      ...
      >
        ...
        <Link
          href="/"
          className="flex items-center mt-4 p-2 rounded hover:bg-gray-100 transition-all"
        >
